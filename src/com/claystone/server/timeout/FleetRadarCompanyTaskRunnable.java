...
public class FleetRadarCompanyTaskRunnable implements Runnable {
	private final Timer timer = new Timer();
	private FleetRadarCompanyTask mobileCompanyTask;
	private String mobileCompanyId;
	private String dataProviderName;
	private Hashtable<String, MobileUnitTimestamp> mCompanyTimestampHash;
	private Logger log = Logger.getLogger(FleetRadarCompanyTaskRunnable.class);

	public FleetRadarCompanyTaskRunnable() {
		mobileCompanyTask = new FleetRadarCompanyTask();
	}
