...
public class ISHIKA_GetData {
	private Logger log;

	public ISHIKA_GetData() {
		log = Logger.getLogger(ISHIKA_GetData.class);

	}
	public ArrayList<GPSDataModel> GetDataFromISHIKA(String URL, String companyID,
